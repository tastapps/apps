...
let saveVideos = (videos, category) => {
  ...
  fs.writeFile(`./tastly/categories/${category}.json`, JSON.stringify({ videos: nvideos }), (error) => { /* handle error */ })
  fs.writeFile(`./tastly/categories.json`, JSON.stringify({ categories: videoCategories }), (error) => { /* handle error */ })
}
